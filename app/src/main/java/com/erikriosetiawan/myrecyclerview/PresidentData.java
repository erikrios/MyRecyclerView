...
public class PresidentData {
    ...
    public static String[][] data = new String[][] {
            ...
            {"Susilo Bambang Yudhoyono", "Presiden Keenam RI", "Presiden Keenam RI", "https://upload.wikimedia.org/wikipedia/commons/5/58/Presiden_Susilo_Bambang_Yudhoyono.png"},
